...
import com.eztruck.eztruckcustomer.InterfaceUtil.InternetCallback;
...
public class RequestObject implements Parcelable {
    ...
    public RequestObject setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public RequestObject setSourceCoordinates(String sourceCoordinates) {
    ...
    public RequestObject setDestinationCoordinates(String destinationCoordinates) {
    ...
    public RequestObject setSearchedLocation(String searchedLocation) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.sourceCoordinates);
        dest.writeString(this.destinationCoordinates);
        dest.writeString(this.searchedLocation);
    ...
    protected RequestObject(Parcel in) {
        ...
        this.sourceCoordinates = in.readString();
        this.destinationCoordinates = in.readString();
        this.searchedLocation = in.readString();
