...
public class HomeJson implements Parcelable
{
    ...
    protected HomeJson(Parcel in) {
        ...
        in.readList(this.featured, (com.eztruck.eztruckcustomer.JsonUtil.HomeUtil.Featured.class.getClassLoader()));
        in.readList(this.trending, (com.eztruck.eztruckcustomer.JsonUtil.HomeUtil.Trending.class.getClassLoader()));
        in.readList(this.nearest, (com.eztruck.eztruckcustomer.JsonUtil.HomeUtil.Nearest.class.getClassLoader()));
    }
