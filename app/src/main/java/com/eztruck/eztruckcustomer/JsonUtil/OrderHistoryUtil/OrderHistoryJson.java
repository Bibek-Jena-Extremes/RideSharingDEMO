...
package com.eztruck.eztruckcustomer.JsonUtil.OrderHistoryUtil;
...
public class OrderHistoryJson implements Parcelable
{
    ...
    protected OrderHistoryJson(Parcel in) {
        ...
        in.readList(this.orderList, (com.eztruck.eztruckcustomer.JsonUtil.OrderHistoryUtil.OrderList.class.getClassLoader()));
    }
