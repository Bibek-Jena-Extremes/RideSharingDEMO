...
package com.eztruck.eztruckcustomer.JsonUtil.ProductUtil;
...
public class ProductJson implements Parcelable
{
    ...
    protected ProductJson(Parcel in) {
        ...
        in.readList(this.products, (com.eztruck.eztruckcustomer.JsonUtil.ProductUtil.Product.class.getClassLoader()));
    }
