...
package com.eztruck.eztruckcustomer.JsonUtil.ReviewUtil;
...
public class ReviewJson implements Parcelable
{
    ...
    protected ReviewJson(Parcel in) {
        ...
        in.readList(this.reviews, (com.eztruck.eztruckcustomer.JsonUtil.ReviewUtil.Review.class.getClassLoader()));
    }
