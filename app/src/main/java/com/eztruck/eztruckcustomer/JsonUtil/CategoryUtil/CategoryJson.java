...
package com.eztruck.eztruckcustomer.JsonUtil.CategoryUtil;
...
public class CategoryJson implements Parcelable
{
    ...
    protected CategoryJson(Parcel in) {
        ...
        in.readList(this.categories, (com.eztruck.eztruckcustomer.JsonUtil.CategoryUtil.Category.class.getClassLoader()));
    }
